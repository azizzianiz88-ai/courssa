  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-6">
      <div className="flex items-center justify-between mb-6 pt-2">
        <h1 className="text-2xl font-black text-foreground tracking-tight">السجل والأرباح</h1>
      ...
      <div className="flex justify-center items-center h-[50vh]">
        ...
        >
          ...
          <h2 className="text-lg font-bold mb-2">السجل فارغ</h2>
          <p className="text-sm text-muted-foreground">
            لم تقم بإكمال أي رحلة بعد. رحلاتك السابقة ستظهر هنا في المستقبل!
          </p>
        </motion.div>
      </div>
    </div>
